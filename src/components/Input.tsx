    ...
    if (typeof props.prefixIcon === "string") {
      return (
        <div className="relative w-full">
          <span className="absolute p-2 pl-3 font-semibold">
            {props.prefixIcon}
          </span>
          <input
            {...props}
            ref={props.ref}
            className={cn(
              "ring-chathams-blue text-chathams-blue dark:ring-woodsmoke-500 dark:bg-woodsmoke-800 relative w-full rounded-md px-3 py-2 pl-10 ring-1 transition-all duration-150 outline-none focus:ring-2 dark:text-white",
              props.className,
